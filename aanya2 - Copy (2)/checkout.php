...
if(isset($_POST['order'])){
   ...
   $address = ' '. $_POST['postal'] .' '. $_POST['street'] .' S'. $_POST['city'] .' '. $_POST['state'] ;
   ...
   <form action="" method="POST">
      ...
      <div class="flex">
         ...
         <div class="inputBox">
            ...
            <input type="text" name="postal" placeholder="e.g. 4600" class="box" required>
         </div>
         <div class="inputBox">
            <span>street :</span>
            <input type="text" name="street" placeholder="e.g. kapan " class="box" required>
         </div>
         <div class="inputBox">
            <span>city :</span>
