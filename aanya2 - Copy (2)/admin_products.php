...
if(isset($_POST['add_product'])){
   ...
   if($select_products->rowCount() > 0){
      ...
      $insert_products = $conn->prepare("INSERT INTO `products`(name, category, details, price, image, qty) VALUES(?,?,?,?,?,?)");
      $insert_products->execute([$name, $category, $details, $price, $image, $qty]);
...
<section class="add-products">
   ...
   <form action="" method="POST" enctype="multipart/form-data">
      <div class="flex">
         ...
         <input type="number" min="1" name="qty" class="box" required placeholder="enter product quantity">
         </div>
      </div>
