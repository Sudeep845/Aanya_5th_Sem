...
<!-- <ul>
   ...
   <li><a href="category.php?category=bags">bags</a></li>
   ...
   <a href="category.php?category=bags">bags</a>
...
<section class="products">
   ...
   <form action="" class="box" method="POST">
      ...
      <input type="number" min="1" max="<?= $fetch_products['qty']; ?>" value="1" name="p_qty" class="qty" value="1" name="p_qty" class="qty">
