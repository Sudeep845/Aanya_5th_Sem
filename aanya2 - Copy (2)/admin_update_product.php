...
if(isset($_POST['update_product'])){
   ...
   $update_product = $conn->prepare("UPDATE `products` SET name = ?, category = ?, qty = ?,details = ?, price = ? WHERE id = ?");
   $update_product->execute([$name, $category, $qty, $details, $price, $pid]);
...
<section class="update-product">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <input type="number" name="qty" min="0" placeholder="enter product quantity" required class="box" value="<?= $fetch_products['qty']; ?>">
